...
void image_to_sub(char pattern_2d[][50], char image_2d[50][50], int img_height, int img_width, char* pattern, int pat_height, int pat_width);

bool compare(char test_array[][50], char pattern_2d[][50], int pat_height, int pat_width);
...
void get_patterns(int argc, char* argv[], char image_2d[50][50], int img_height, int img_width){
    ...
    for(int i = 2; i < argc; i++){
        ...
        char pattern_2d[pat_height][pat_width];
        ...
        image_to_sub(pattern_2d, image_2d, img_height, img_width, pattern, pat_height, pat_width);
...
void image_to_sub(char pattern_2d[][50], char image_2d[50][50], int img_height, int img_width, char* pattern, int pat_height, int pat_width){
    ...
    for (int i = 0; i < img_height; i++){
        ...
        for (int j = 0; j < img_width; j++){
            ...
            char test_array[pat_height][pat_width];

            //bounds checking to make sure it is getting a proper 3x3 array
            if(img_width - j >= pat_width && img_height - i >= pat_height){
                ...
                bool match = compare(test_array, pattern_2d, pat_height, pat_width);
